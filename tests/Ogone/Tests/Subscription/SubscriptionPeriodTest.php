...
class SubscriptionPeriodTest extends \TestCase
{
    ...
    {
        return [
            [SubscriptionPeriod::UNIT_DAILY],
            [SubscriptionPeriod::UNIT_WEEKLY],
            [SubscriptionPeriod::UNIT_MONTHLY],
        ];
    }
    ...
    {
        return [
            [SubscriptionPeriod::UNIT_WEEKLY, 8],
            [SubscriptionPeriod::UNIT_MONTHLY, 29],
        ];
    }
