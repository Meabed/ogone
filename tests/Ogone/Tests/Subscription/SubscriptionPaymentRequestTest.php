...
class SubscriptionPaymentRequestTest extends \TestCase
{
    ...
    public function provideBadParameters()
    {
        ...
        return [
            ['setAmount', 10.50],
            ['setAmount', -1],
            ['setAmount', 150000000000000000],
            ['setSubscriptionId', 'this is a little more than 50 characters, which is truly the max amount'],
            ['setSubscriptionId', '$e©ial Ch@r@cters'],
            ['setSubscriptionAmount', 10.50],
            ['setSubscriptionAmount', 0],
            ['setSubscriptionAmount', -1],
            ['setSubscriptionAmount', 150000000000000000],
            ['setSubscriptionDescription', 'this is a little more than 100 characters- which is truly the maximum amount of characters one can pass as a parameter to this particular function'],
            ['setSubscriptionDescription', 'special, characters!'],
            ['setSubscriptionOrderId', 'this is a little more than 40 characters- which is truly the max amount'],
            ['setSubscriptionOrderId', 'special, characters!'],
            ['setSubscriptionStatus', 5],
            ['setSubscriptionComment', 'this particular string is supposed to be longer than 200 characters- which will require me to type for quite a while longer than the string that needed to exceed 50 chars- which is- in fact- significantly lower than 200'],
            ['setSubscriptionComment', 'special, characters!'],
        ];
    }
